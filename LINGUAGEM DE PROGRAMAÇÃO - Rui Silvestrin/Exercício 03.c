...
2 - getchar() -> le um caracter da entrada padrao (no caso teclado) + o ENTER. /// = scanf%c
...
A forma geral da funcao printf() eh:
...
4 - Acrescente ao exer#define ex1
#include "stdio.h"
...
6 - Escreva um programa que determine o menor multiplo de um numero inteiro. Este
    multiplo de ser maior que o limite minimo recebido. Recebe os 2 numeros via
    teclado.
...
*/
cicio anterior mais uma linha. Receba via teclado os valores
    sem sinal char, int e long int e escrevendo nas coluna 10, 30 e 50.
